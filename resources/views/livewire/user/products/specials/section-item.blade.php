<div class="card-scroll-item">
    ...
    @if (!$product->deleted_at && $product->special && !$product->has_offer)
        <div class="product-card h-100">

            <!-- شارة مميز -->
            <span class="badge-featured"><i class="bi bi-star-fill me-1"></i>مميز</span>
            ...
            @endif
            <!-- الصورة -->
            <a href={{ route('user.product', ['type' => 'special', 'id' => $product->id]) }} class="card-img-wrapper">
            ...
            <div class="card-body">
                ...
                <a href={{ route('user.product', ['type' => 'special', 'id' => $product->id]) }}

    ...
    @switch($show)
        @case('ableToEdit')
            <form action="" target="" method="POST">
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">اسم الصنف: <span class="tx-danger"><x-input-error
                                input="name"></x-input-error></span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input wire:model='name' type="text" class="form-control" placeholder="أدخل اسم الصنف">
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">ترتيب الصنف: <span class="tx-danger"><x-input-error
                                input="order"></x-input-error></span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input wire:model='order' type="text" class="form-control" placeholder="أدخل ترتيب الصنف">
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">صورة الصنف:</label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                @else
                    @if ($tag->img != null && $img_updated == false)
                        <img src={{ asset('tags/imgs/' . $tag->img->path) }} alt="" width="200px" hight="200px">
                    @endif
                @endif
        ...
        @case('ableToRemove')
            <form action="" target="" method="POST">
                ...
                @endif
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">اسم الصنف:</label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        {{ $tag->name }}
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">ترتيب الصنف: </label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        {{ $tag->order }}
                    </div>
                </div>

    ...
    @switch($show)
        @case('ableToEdit')
            <form action="" target="" method="POST">
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">اسم الماركة: <span class="tx-danger"><x-input-error
                                input="name"></x-input-error></span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input wire:model='name' type="text" class="form-control" placeholder="أدخل اسم الماركة">
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">ترتيب الماركة: <span class="tx-danger"><x-input-error
                                input="order"></x-input-error></span></label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        <input wire:model='order' type="text" class="form-control" placeholder="أدخل ترتيب الماركة">
                    </div>
                </div>
                <div class="row mg-t-20">
                ...
                @else
                    @if ($brand->img != null && $img_updated == false)
                        <img src={{ asset('brands/imgs/' . $brand->img->path) }} alt="" width="200px" hight="200px">
                    @endif
                @endif
        ...
        @case('ableToRemove')
            <form action="" target="" method="POST">
                ...
                @endif
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">اسم الماركة:</label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        {{ $brand->name }}
                    </div>
                </div>
                <div class="row mg-t-20">
                    <label class="col-sm-4 form-control-label">ترتيب الماركة: </label>
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        {{ $brand->order }}
                    </div>
                </div>
                ...
                <div class="row mg-t-20">
                    ...
                    <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                        {{ $brand->updated_at->format('Y/m/d | H:i') }}
                    </div>
                </div>
                <div class="form-layout-footer mg-t-30">

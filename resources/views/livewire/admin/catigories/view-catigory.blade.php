                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-12 mg-b-20">
                        ...
                        <div class="input-group">
                            ...
                            <input list="catigories" wire:model.live.debounce.1000ms="search"
                                class="form-control bd bd-l-0 pd-l-10" placeholder="بحث عن...">
                            <datalist id="catigories">
            ...
            @foreach ($catigories as $catigory)
                <div class="col-xl-6 col-md-6 mg-t-20">
                    <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                        @livewire('admin.catigories.catigory', ['catigory' => $catigory], key($catigory->id))
                    </div>
                </div>
            @endforeach
        </div>

    ...
    <div class="container">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <!-- زر التفعيل -->
                <a href="{{ route('user.verify.verifyUser', ['token' => $token]) }}" class="btn-verify">
                    تفعيل حسابي الآن
                </a>
                ...
                <div class="mt-4">
                    ...
                    <br>
                    <a href="{{ route('user.verify.verifyUser', ['token' => $token]) }}"
                        style="word-break: break-all; color: #007bff; font-size: 0.85em;">
                        {{ route('user.verify.verifyUser', ['token' => $token]) }}
                    </a>
                </div>

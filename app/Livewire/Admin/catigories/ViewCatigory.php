...
class ViewCatigory extends Component
{
    use WithPagination;
    ...
    public function resetFilters()
    {
        ...
        $this->reset("CreatedAt", "UpdatedAt", "CatigoryName", "sortAs", "Available", "UnAvailable");
    }
    public $results = [];
    public $search = "";
    public $CatigoryName = "";
    ...
    {
        $this->resetFilters();
        $this->results = Catigory::where("name", "like", "%" . $this->search . "%")->take(10)->get("name");
        $this->CatigoryName = $this->search;
    }
    #[Computed()]
    public function catigories()
    {
        return Catigory::with("img")->where("name", "like", "%" . $this->CatigoryName . "%")
    ...
    {
        return view('livewire.admin.catigories.view-catigory', [

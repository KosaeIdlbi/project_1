...
class SectionItem extends Component
{
    ...
    public function addToCart()
    {
        if ($this->user) {
            ...
            $this->dispatch("refreshCartButton", "add", $this->product->offer_price);
        } else {
            $this->dispatch("loginAlert");
        }
    }
    public function removeFromCart()
    {
        if ($this->user) {
            ...
            $this->dispatch("refreshCartButton", "remove", $this->product->offer_price);
        } else {
            $this->dispatch("loginAlert");
        }
    }
    ...
    {
        return view('livewire.user.products.offers.section-item');
    }
}
